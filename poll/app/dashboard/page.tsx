    ...
    return (
        <section className="m-4 flex max-h-screen flex-col gap-10 rounded-2xl bg-[#f7f7f7] p-6">
            ...
            <section className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6">
                <article className="flex flex-row justify-between rounded-xl bg-white p-6">
                    <div className="grid gap-2">
                        <p className="text-sm uppercase text-[#7b7b7b]">
                            Total polls
                        </p>
            ...
            <section className="">
                <h3 className="text-sm font-semibold text-[#7b7b7b]">POLLS</h3>
                <div className="mt-6 rounded-xl bg-white p-6">
                    <table className="w-full">
                        <thead>
                            <tr className="bg-gray-20 border-b border-[#e0e0e0] text-xs uppercase text-[#7b7b7b]">
                    ...
                    <div className="mt-6 flex flex-row items-center justify-between">
                        <p className="mt-4 items-center text-sm text-[#7b7b7b]">
